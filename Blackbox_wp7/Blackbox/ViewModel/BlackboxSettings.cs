...
namespace Blackbox
{
    ...
    public class BlackboxSettings : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<string> _difficultyList = null;
        #endregion

        #region constructor
        public BlackboxSettings()
        {
            _difficultyList = new ObservableCollection<string>();
            _difficultyList.Add(AppResources.EasyText);
            _difficultyList.Add(AppResources.ChallengeText);
        ...
        #region Difficulty list
        public ObservableCollection<string> DifficultyList
        {
            get
            {
