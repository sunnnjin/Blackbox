...
namespace Blackbox
{
    public partial class HelpPage : PhoneApplicationPage
    {
        ...
        private ApplicationBarIconButton previous;
        private ApplicationBarIconButton next;
        ...
        public HelpPage()
        {
            ...
            previous =
                new ApplicationBarIconButton(
                    new Uri("/icons/Appbar/Appbar.previous.png", UriKind.Relative));
            previous.Text = AppResources.PreviousApplicationBarText;
            previous.Click += new EventHandler(previous_Click);

            next =
                new ApplicationBarIconButton(
                    new Uri("/icons/Appbar/Appbar.next.png", UriKind.Relative));
            ...
            this.TitleTextBox.Foreground = 
                new SolidColorBrush(Color.FromArgb(255, 140, 138, 140));
            this.DetailsTextBox.Foreground = 
                new SolidColorBrush(Color.FromArgb(255, 160, 160, 160));

            this.AboutButton.Background = 
                new SolidColorBrush(Color.FromArgb(255, 49, 153, 204));
            this.AboutButton.BorderBrush = 
                new SolidColorBrush(Color.FromArgb(255, 49, 153, 204));
            this.AboutButton.Foreground = 
